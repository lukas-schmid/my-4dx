...
export const demoUserCommitmentDataMock = [
    ...
    {startDate: addDays('2021-01-04', 42),commitmentName: 'Complete face-to-face meetings with two companies that have just opened new offices downtown', category: 'Complete two quality site visits per associate per week', isCompleted: false},
    {startDate: addDays('2021-01-04', 49),commitmentName: 'Create a special upsell experience for our premium bar package with the three clients that were scheduled for site visits', category: 'Upsell our premium bar package to 90% of all events', isCompleted: false},
    ...
    {startDate: addDays('2021-01-04', 91),commitmentName: 'Send a memories packet to two of my clients who held events with us last year, along with a handwritten note.', category: 'Complete two quality site visits per associate per week', isCompleted: true},
