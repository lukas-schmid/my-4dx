...
export default function UserAccountForm() {
    ...
    return (
        <form className="form" onSubmit={handleSubmit}>
            ...
            <h3 className="form-title mt-30 mb-10">Change Email:</h3>
            <div className="form-section mt-0">
                <input type="email" className="form-control mb-10" id="currentEmail" name="currentEmail" placeholder="Current email" defaultValue={currentUserInfo && currentUserInfo.email}/>
                <input type="email" className="form-control" id="newEmail" name="newEmail" placeholder="Enter new email"/>
            </div>
